...
export default function ProductsPage() {
   ...
   */
  const filteredData = productsQuery.data?.filter(
    (p) =>
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (stockQuantity: number) => (
        <Tag
          color={
            stockQuantity < 10 ? "red" : stockQuantity < 50 ? "orange" : "blue"
          }
      ...
      >
        ...
        >
          <Form.Item
            name="name"
            label={
              <Text className="font-medium text-slate-600">Product Name</Text>
            }
          ...
          <div className="grid grid-cols-2 gap-4">
            <Form.Item
              name="price"
              label={
                <Text className="font-medium text-slate-600">Unit Price</Text>
              }
          ...
          <div className="flex justify-end gap-3 mt-8">
            <Button onClick={() => setIsModalOpen(false)} className="h-11 px-6">
              Cancel
            </Button>
            <Button
              type="primary"
