        ...
        <div className="px-2">
          <Space direction="vertical" size={2} className="mb-8">
            <div className="flex items-center gap-2">
              <Title level={2} className="m-0 text-slate-800">Administrator</Title>
              <VerifiedOutlined className="text-blue-500 text-xl" />
            </div>
            <Text type="secondary" className="text-slate-500 font-medium">System Operator • POS Buzz Enterprise</Text>
          </Space>
          ...
          >
            ...
            <Descriptions.Item label="Role">
              <Tag color="blue" className="rounded-full px-4 font-bold border-none">ADMIN</Tag>
            </Descriptions.Item>
            <Descriptions.Item label="Status">
              <Badge status="processing" text="Active Session" className="text-slate-600" />
            </Descriptions.Item>
          </Descriptions>
        </div>
      </Card>
