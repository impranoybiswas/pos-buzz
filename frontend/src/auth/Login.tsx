...
import { ShoppingCartOutlined, MailOutlined, LockOutlined } from "@ant-design/icons";
      ...
      <div className="hidden lg:flex flex-col justify-center items-center bg-blue-600 p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 max-w-md">
          ...
          <Text className="text-blue-100 text-lg block">
            The next generation of point of sale management. Fast, efficient, and beautifully designed.
          </Text>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-8 bg-slate-50 lg:bg-white">
        <Card bordered={false} className="w-full max-w-md shadow-2xl lg:shadow-none bg-transparent">
          ...
          <div className="mb-10 text-center lg:text-left">
            <Title level={1} className="m-0 !text-3xl font-extrabold text-slate-800">Login</Title>
          ...
          >
            ...
            <div className="text-center mt-8">
              <Space>
                ...
                <Link to="/register" className="text-blue-600 hover:text-blue-800 font-bold decoration-2 underline-offset-4">
                  Create an Account
                </Link>
              </Space>
            </div>
